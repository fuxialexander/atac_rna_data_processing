...
from atac_rna_data_processing.io.mutation import prepare_gnomad_data 
# %%
prepare_gnomad_data()

# %%
from atac_rna_data_processing.io.mutation import predict_celltype_exp

predict_celltype_exp(155, )